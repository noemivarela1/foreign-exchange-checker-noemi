...
export function TabLog({ amount }) {
    ...
    return (
        <div className="flex flex-col w-[1036px] gap-250 p-250 text-neutral-200 mx-auto bg-neutral-900/30 rounded-xl border border-neutral-800">
            {/* Cabeceira co contador e o botón de borrar */}
            <div className="flex justify-between items-center border-b border-neutral-800 pb-250">
                <h3 className="text-preset-3 uppercase text-lime-500 font-bold tracking-wider">
                    Conversion Log
                </h3>
            ...
            <div className="flex flex-col gap-2 max-h-[596px] w-[996px] overflow-y-auto pr-2 no-scrollbar">
                {conversionLog.map((log) => (
                    <div
                        key={log.id}
                        className="flex justify-between items-center h-[64px] gap-200 p-200 bg-neutral-600/80 rounded-lg border border-neutral-600/50 hover:border-neutral-500/50 transition-all duration-150"
                    >
                        <div className="flex items-center">   
                            {/* Tempo transcorrido relativo */}
                            <div className="text-preset-4 text-neutral-200 gap-100 bg-neutral-900/60 w-[64px] rounded-full border border-neutral-700/30">
